            ...
            <div className='lg:flex w-full justify-between grid md:grid-cols-4 grid-cols-2 gap-6'>
              <div className='text-[#7d8590]'>
                ...
                <ul className='text-[14px]'>
                    ...
                    <li className='mb-4'><a href="">Compare Zidio</a></li>
                </ul>
              </div>
              <div className='text-[#7d8590]'>
                ...
                <ul className='text-[14px]'>
                    ...
                    <li className='mb-4'><a href="">ZidioDesktop</a></li>
                </ul>
              </div>
              <div className='text-[#7d8590]'>
                <h2 className='font-medium mb-4 font-mono'>Product</h2>
                <ul className='text-[14px]'>
                    ...
                    <li className='mb-4'><a href="">Contact Zidio</a></li>
                </ul>
              </div>
              <div className='text-[#7d8590]'>
      ...
      <div className='bg-[#161b22]'>
        <div className='max-w-[1280px] mx-auto text-[12px] md:flex flex-row-reverse py-6 justify-between items-center px-4'>
          <ul className='flex items-center max-md:mb-4  '>
            ...
            <li className='mr-4'>
              <a href=""><Image src="https://github.githubassets.com/images/modules/site/icons/footer/facebook.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
            <li className='mr-4'>
            ...
            <li className='mr-4'>
              <a href=""><Image src="https://github.githubassets.com/images/modules/site/icons/footer/youtube.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
            <li className='mr-4'>
            ...
            <li className='mr-4'>
              <a href=""><Image src="https://github.githubassets.com/images/modules/site/icons/footer/tiktok.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
            <li>
          ...
          <ul className='flex items-center mb-4 sm:mb-0 text-[#7d8590] flex-wrap' >
            <li className="mr-3 ">© 2023 Zidio, Inc.</li>
            ...
            <li className='mr-3 '><a href="">What is zidio?</a></li>
          </ul>
        </div>
      </div>
      </div>
