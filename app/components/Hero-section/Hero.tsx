    ...
    <div className='relative max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16'>
        ...
        <div className='flex'>
            <div className='relative '>
                ...
                <div style={{ background: 'linear-gradient(#d2a8ff, #a371f7 10%, #196c2e 70%, #2ea043 80%, #2980b9)', marginLeft:'11px' }} className= " max-md:w-[2px] w-[3px] h-[450px] max-md:h-[650px] max-sm:h-[750px] max-ssm:h-[900px] max-sssm:h-[1150px] line rounded-md"></div>
            </div>
            <div className= ' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                    ...
                    <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="" className=' border-[1px] border-neutral-600 copilot rounded-full inline-block'>
                        <div className='flex items-center p-3 px-5'>
                            ...
                            <div className='md:pr-5 pr-3 md:mr-2 md:pl-2'>
                                <div className='font-medium text-white text-[16px] max-md:text-[14px] leading-5'>IntroducingZidioCopilot X</div>
                ...
                <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[80px] font-semibold text-white"> Innovating Digital Solutions for Tomorrow</h1>
                ...
                Empowering your journey with innovative tech,
                we accelerate your success every step of the way.
                </p>
